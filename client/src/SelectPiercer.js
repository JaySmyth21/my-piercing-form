    ...
    const fetchWaitTimes = async () => {
      try {
        const res = await axios.get(
          "https://my-piercing-form.onrender.com/api/location-status"
        );
    ...
    const fetchPiercers = async () => {
      try {
        const response = await axios.get(
          "https://my-piercing-form.onrender.com/api/piercers"
        );
      ...
      <div className="w-3/4 bg-white p-8 rounded-lg shadow-lg">
        ...
        {loading ? (
          <p className="text-center text-gray-600">
            Checking who's available today...
          </p>
