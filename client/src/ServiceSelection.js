                ...
                <div className="space-y-4">
                              ...
                              >
                                <div className="p-4 space-y-4">
                                  {sortedServices.map((service) => {
                                    ...
                                    const disableOtherServices =
                                      values.services.some((s) =>
                                        specialServices.includes(s)
                                      );
                                    const disableSpecialServices =
                                    ...
                                    const isDisabled =
                                      (disableOtherServices &&
                                        !specialServices.includes(
                                          service.name
                                        )) ||
                                      (disableSpecialServices &&
                                        specialServices.includes(service.name));

                                    const disableExtra =
                                      values.services.length >= 3 && !isChecked;
                  ...
                  <div className="flex flex-col sm:flex-row justify-between mt-6 mx-4 sm:mx-auto sm:w-3/4">
                    <button
                      ...
                      onClick={() => navigate("/select-piercer", {})}
                    >
                      Previous
                    </button>
                    <button
